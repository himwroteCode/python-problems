...
#BED and #Cab satisfy the Hex Color Code criteria, but they are used
#as selectors and not as color codes in the given CSS.
...
for i in range(n):
    line = input().strip()
    color_codes = re.findall(pattern, line)
